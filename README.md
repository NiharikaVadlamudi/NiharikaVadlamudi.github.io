...
- Bio / homepage: [`_pages/about.md`](_pages/about.md)
- Publications: [`_bibliography/papers.bib`](_bibliography/papers.bib)
- CV: [`_data/cv.yml`](_data/cv.yml) and [`assets/json/resume.json`](assets/json/resume.json)
- Projects: [`_projects/`](_projects/)
- News: [`_news/`](_news/)
- Social links / email: [`_data/socials.yml`](_data/socials.yml)
- Site-wide settings: [`_config.yml`](_config.yml)

Local dev: `bundle install && bundle exec jekyll serve` (see [docs/INSTALL.md](docs/INSTALL.md)).
